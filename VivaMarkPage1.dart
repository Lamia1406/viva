...
Mark(){
  return (double.parse(supervisorMark.text)*6+double.parse(presidentMark.text)*6+double.parse(examinatorMark.text)*8)/20;
}
  @override
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create:(context)=> Projects(),
    child: Scaffold(
      appBar: AppBar(
        centerTitle: true,
...
class Projects with ChangeNotifier{
  ...
  var year=year.text;
  var students=[firstStudent.text,secondStudent.text,thirdStudent.text];
 var supervisorMark=supervisorMark.text;
 var president=presidentName.text;
 var presidentMark=presidentMark.text;
 var examiner=examinatorName.text;
  var examinerMark=examinatorMark.text;
  displayOneProjectData(){
