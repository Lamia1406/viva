      ...
      return Container(
        ...
        child:TextFormField(
          ...
          validator:  (controller){
            ...
            if(double.parse(controller)> note){
                        ...
                        Container(
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              TableRow(
                                  children:[
                                    Column1('Scientific content: clarity of problematic, work methodology, conclusion,....'),
                                    Container(
                                      alignment: Alignment.center,
                                      child: Text('1'),
                                    ),
                              ...
                              TableRow(
                                  children:[
                                    Column1('Ergonomics / clarity of analysis'),
                                    Container(
                                      alignment: Alignment.center,
                                      child: Text('1'),
                                    ),
                              ...
                              TableRow(
                                  children:[
                                    Column1('Development effort / Analysis: originality'),
                                    Container(
                                      alignment: Alignment.center,
                                      child: Text('1'),
                                    ),
                              ...
                              TableRow(
                                  children:[
                                   Column1('Fluent oral expression'),
                                    Container(
                                      alignment: Alignment.center,
                                      child: Text('1'),
                                    ),
                              ...
                              TableRow(
                                  children:[
                                    Column1('Well-posed problematic'),
                                    Container(
                                      alignment: Alignment.center,
                                      child: Text('1'),
                                    ),
